...
a = 4
b = 8
#resultado solo almacenara la operacion matematica por lo que no hay problema que sea igual a 0
resultado = 0
#Se usa el ciclo for para que x, como valor del rango a, sea el numero de veces que se sumara el valor b
for x in range(a):
    #esto tambien se puede escribir como resultado= resultado + b
    resultado += b
...
#primero concatenamos los string para que se escrivan ambas variables como un texto completo y el ::-1 hara que se lea de derecha a izquierda
